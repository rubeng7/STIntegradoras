...
-- Volcando datos para la tabla stintegradoras.carrera: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla stintegradoras.comite: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `comite` DISABLE KEYS */;
INSERT INTO `comite` (`idComite`, `nombre`, `descripcion`, `idPeriodo`) VALUES
	(1, 'Mi comite', 'skdfksjdf', 1),
	(3, 'Comite 2', 'sdf', 2);
...
-- Volcando datos para la tabla stintegradoras.comite_profesor: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla stintegradoras.direccion: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla stintegradoras.empresa: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla stintegradoras.periodo: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla stintegradoras.persona: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `persona` DISABLE KEYS */;
INSERT INTO `persona` (`idPersona`, `nombre`, `paterno`, `materno`, `idDivision`) VALUES
	(1, 'Ruben', 'García', 'Ruiz', 2),
...
-- Volcando datos para la tabla stintegradoras.profesor: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `profesor` DISABLE KEYS */;
INSERT INTO `profesor` (`idProfesor`, `nivelEstudios`, `especialidad`, `enComite`, `enIntegradora`) VALUES
	(1, 'Ingeniería', 'Sistemas', 1, 1);
...
-- Volcando datos para la tabla stintegradoras.profesor_grupo_periodo: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla stintegradoras.usuario: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`idUsuario`, `username`, `password`, `rol`, `activo`) VALUES
	(1, 'ruben', '12345678', 'Profesor', 1),
