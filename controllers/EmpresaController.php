...
class EmpresaController extends Controller {
     ...
     * @return mixed
     */
    private function registrar($model, $direccion) {
        ...
        if ($direccion->save()) {
            $model->idDireccion = $direccion->idDireccion;
            if ($model->save()) {
                $transaccion->commit();
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && $direccion->load(Yii::$app->request->post())) {
            $this->registrar($model, $direccion);
        }
